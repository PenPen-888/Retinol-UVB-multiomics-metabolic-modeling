...
def drawHeatmap(PG, hmType, filename, pzero,
                convertGeneNamesFromType="",
                convertGeneNamesToType="",
                convertGeneNamesSpecies="",
                saveMatrix=False,
                matrixFilename="heatmap_matrix"):
    ...
    if saveMatrix:
        export_df = plotmat.iloc[row_denD['leaves'], colorder]
        export_df.to_csv(matrixFilename)
